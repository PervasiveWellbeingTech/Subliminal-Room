...
def test():
    ...
    # time.sleep(10)
    # print('b')
    # change_state(fan_volume=80, box_status=1, fan_speeds=[0,100,0,0], fan_states=[False,True,False,False])
    # time.sleep(10)
    # print('c')
    # change_state(fan_volume=100, box_status=1, fan_speeds=[0,0,100,0], fan_states=[False,False,True,False])
    # time.sleep(10)
    # print('d')
    # change_state(fan_volume=80, box_status=1, fan_speeds=[0,0,0,100], fan_states=[False,False,False,True])
    # time.sleep(10)
    # reset()
