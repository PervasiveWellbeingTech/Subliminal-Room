...
def test():
    ...
    # change_state(fan_volume=100, box_status=1, fan_speeds=[100,0,0,0], fan_states=[True,False,False,False])
    # time.sleep(3)
    # change_state(fan_volume=100, box_status=1, fan_speeds=[0,100,0,0], fan_states=[False,True,False,False])
    # time.sleep(3)
    # change_state(fan_volume=80, box_status=1, fan_speeds=[0,0,100,0], fan_states=[False,False,True,False])
    # time.sleep(3)
